...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "sese_translator@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "sese_translator API";

        private String description = "sese_translator API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "sese_translator";
