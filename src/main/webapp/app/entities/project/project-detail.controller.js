(function () {
    ...
    ProjectDetailController.$inject = ['$scope', '$rootScope', '$http', '$stateParams', 'previousState', 'entity', 'Project', 'Release', 'User'];

    function ProjectDetailController($scope, $rootScope, $http, $stateParams, previousState, entity, Project, Release, User) {
        var vm = this;
