(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('seseTranslatorApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-seseTranslatorApp-error');
                var entityKey = httpResponse.headers('X-seseTranslatorApp-params');
                if (errorHeader) {
